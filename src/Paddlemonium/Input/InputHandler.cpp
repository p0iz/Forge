...
InputHandler::InputHandler(Forge::HighResClock& clock, Forge::QtRenderer& renderer, Forge::Graphics::RenderWindowPtr renderWindow)
  : mClock(clock), mSceneConfig(nullptr), mRenderer(renderer), mRenderWindow(renderWindow)
{
  mapDefaultKeys();
}
