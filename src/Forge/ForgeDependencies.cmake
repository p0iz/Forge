...
if(NOT EXISTS ${GLM_DIR})
  if(WIN32)
    message(ERROR "You need to add/clone GLM headers into 'deps/glm' (https://github.com/g-truc/glm/releases)")
  elseif(NOT EXISTS "/usr/include/glm")
    message("GLM installation not found in default prefix. Install GLM via package management or add/clone GLM headers into 'deps/glm' (https://github.com/g-truc/glm/releases)")
  endif()
else()
